...
- `scripts/check_code.R`: static verification script.
...
The check parses all R files, confirms that required files are present, and verifies that no generated fit outputs are stored in the repository.
